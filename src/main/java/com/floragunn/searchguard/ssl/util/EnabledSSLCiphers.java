...
public final class EnabledSSLCiphers {

    private static final ESLogger log = Loggers.getLogger(EnabledSSLCiphers.class);
    ...
    public static String[] getEbabledSSLCiphers() {
